...
if(!args[0]) return message.channel.send(nn.setTitle('Bir hata oldu!').setDescription(`Bir **TAG** ve ya **SIMGE** koymayı unuttunuz.`).setImage('https://media.giphy.com/media/lH2Dbxmb7zYngOcMhu/giphy.gif')).then(a => a.delete({timeout: 10000}));
